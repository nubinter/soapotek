          ...
          <?php foreach($jurnal_umum as $c){ ?>
					...
					echo "";
							...
							<td style=" text-align: center;">
								<?php echo anchor('example/edit_form_cat/'.$c->nama_perkiraan, '<button class="btn btn-info btn-xs" type="button"><span class="fa fa-pencil"></span></button>'); ?>
								<?php echo anchor('example/remove_cat/'.$c->nama_perkiraan, '<button class="btn btn-danger btn-xs" type="button"><span class="fa fa-trash"></span></button>');?>
					         </td>
						</tr>
						<?php $sn++; ?>
