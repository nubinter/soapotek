	...
	function add_medicine()
	{
		$nama_obat = $this->input->post('nama_obat');
			...
			$data_jurnal = array(
				...
				'debet' => $harga_obat*$jmlh_stok,
				'keterangan' => 'Pembelian',
			);
			
			//Pembelian obat menambah saldo Debet di Jurnal Umum
			$this->apotek_data->insert_data($data_jurnal, 'tbl_jurnal_umum');
			
			$data_jurnal = array(
				'tanggal' => $tgl_beli,
				'nama_perkiraan' => 'Kas',
				'kredit' => $harga_obat*$jmlh_stok,
				'keterangan' => 'Pembelian',
			);
			
			//Pembelian obat menambah saldo Kredit Kas di Jurnal Umum
			$this->apotek_data->insert_data($data_jurnal, 'tbl_jurnal_umum');
			...
			$data_buku_besar = array(
				...
				'ref' => '112',
				'debet' => $harga_obat*$jmlh_stok,
				'keterangan' => 'Pembelian '.$nama_obat.' dari '.$nama_supplier,
			);
